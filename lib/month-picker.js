...
var MonthPicker = _react2.default.createClass({
    ...
    propTypes: {
        ...
        onClickNextYear: _react2.default.PropTypes.func,
        onClickPrevYear: _react2.default.PropTypes.func,
    ...
    render: function render() {
        ...
        return _react2.default.createElement(
            'div',
            { className: ["month-picker", this.props.className, this.state.showed ? "show" : ""].join(' ') },
            this.props.children,
            _react2.default.createElement(
                'div',
